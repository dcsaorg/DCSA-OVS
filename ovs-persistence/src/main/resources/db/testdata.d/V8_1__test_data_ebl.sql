...
INSERT INTO transport_call (
    ...
    'TC-REF-08_01-B',
    1,
    (SELECT id FROM facility WHERE un_location_code = 'NLRTM' AND facility_smdg_code = 'APM'),
    'COFS',
    null,
    null,
...
INSERT INTO cargo_item (
    ...
    (SELECT id FROM consignment_item WHERE shipping_instruction_id = '9d5965a5-9e2f-4c78-b8cb-fbb7095e13a0' AND hs_code = '411510'),
    50.0,
    'KGM',
    5000,
    '123',
    ...
    (SELECT id FROM consignment_item WHERE shipping_instruction_id = '9d5965a5-9e2f-4c78-b8cb-fbb7095e13a0' AND hs_code = '720711'),
    1000.0,
    'KGM',
    1,
    '456',
